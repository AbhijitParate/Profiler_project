...
public final class Constants {
    ...
    // Geofence parameters for location Home
    public static final String ANDROID_HOME_ID = "1";
    public static final double ANDROID_HOME_LATITUDE = 37.7178840;
    public static final double ANDROID_HOME_LONGITUDE = -122.083648;
    public static final float ANDROID_HOME_RADIUS_METERS = 60.0f;

    // Geofence parameters for location Work
    public static final String WORK_ID = "2";
    public static final double WORK_LATITUDE = 37.784886;
    public static final double WORK_LONGITUDE = -122.402671;
    public static final float WORK_RADIUS_METERS = 72.0f;
